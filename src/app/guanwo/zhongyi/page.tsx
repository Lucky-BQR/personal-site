...
export default function Page() {
  ...
  return (<div className="max-w-3xl mx-auto px-6 py-20 sm:py-24">
    ...
    <p className="text-[10px] font-semibold uppercase tracking-[0.12em] mb-5" style={{color:'var(--color-textMuted)'}}>{t('guanwo','tcm')}</p>
    <h1 className="text-[clamp(1.35rem,4vw,2rem)] mb-4" style={{color:'var(--color-text)'}}>{t('guanwo','tcm')}</h1>
    <p className="text-[15px] leading-relaxed mb-14" style={{color:'var(--color-textSecondary)',lineHeight:1.75}}>{t('guanwo','tcm_desc')}</p>
